...
- [Define iwaya as a Secret-Aware Execution Recipe Runner](20260806T133954Z_secret-aware-execution-recipe-runner.md) keeps this non-sandbox boundary in force while replacing the individual mitigations listed below.
